...
class LuaLatexEngine extends BaseCompilerEngine {
  constructor() {
    super(
      'lualatex',
      'LuaLaTeX',
      'Advanced TeX engine featuring an embedded Lua interpreter and OpenType font support'
    );
  }
